...
static int print_line(int passed, const char *h, const char *str, int ln, size_t col, size_t line_start, size_t line_end, int *h_len)
{
	print_header(passed, NULL, NULL, 0);

	int app = 0;
	*h_len	= t_printf("%s:%d: ", h, ln);
...
static int print_wline(int passed, const char *h, const wchar_t *str, int ln, size_t col, size_t line_start, size_t line_end, int *h_len)
{
	print_header(passed, NULL, NULL, 0);
